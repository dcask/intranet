...
(function($) {
	...
	if (verto.options.sessid) {
	    ...
	    userVariables: verto.options.userVariables,
            sessid: verto.sessid,
            onmessage: function (e) { //function(dialog, message, data) {
		//if (verto.callbacks.onMessage) {
                //    verto.callbacks.onMessage(verto, dialog, message, data);
                //}
		...
		console.log('verto.js-onwslogin');
	...
	console.log("Data-Message:",data.method);
